...
namespace fastpix.io.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum GetTimeseriesDataMetricId
    {
        [JsonProperty("views")]
        Views,
    ...
    public static class GetTimeseriesDataMetricIdExtension
    {
        public static string Value(this GetTimeseriesDataMetricId value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GetTimeseriesDataMetricId ToEnum(this string value)
        {
            foreach(var field in typeof(GetTimeseriesDataMetricId).GetFields())
            {
                ...
                {
                    return (GetTimeseriesDataMetricId)field.GetValue(null);
                }
            }
