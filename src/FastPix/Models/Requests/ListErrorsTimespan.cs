...
namespace fastpix.io.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListErrorsTimespan
    {
    ...
    public static class ListErrorsTimespanExtension
    {
        public static string Value(this ListErrorsTimespan value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListErrorsTimespan ToEnum(this string value)
        {
            foreach(var field in typeof(ListErrorsTimespan).GetFields())
            {
                ...
                {
                    return (ListErrorsTimespan)field.GetValue(null);
                }
            }
