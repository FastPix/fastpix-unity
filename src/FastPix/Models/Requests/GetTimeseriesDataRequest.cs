...
namespace fastpix.io.Models.Requests
{
    ...
    public class GetTimeseriesDataRequest
    {
        ...
        public GetTimeseriesDataMetricId MetricId { get; set; } = default!;
        ...
        public GetTimeseriesDataSortOrder? SortOrder { get; set; }
        ...
        public GetTimeseriesDataTimespan Timespan { get; set; } = default!;
