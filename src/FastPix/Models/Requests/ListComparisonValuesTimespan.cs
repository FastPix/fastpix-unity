...
namespace fastpix.io.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListComparisonValuesTimespan
    {
    ...
    public static class ListComparisonValuesTimespanExtension
    {
        public static string Value(this ListComparisonValuesTimespan value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListComparisonValuesTimespan ToEnum(this string value)
        {
            foreach(var field in typeof(ListComparisonValuesTimespan).GetFields())
            {
                ...
                {
                    return (ListComparisonValuesTimespan)field.GetValue(null);
                }
            }
