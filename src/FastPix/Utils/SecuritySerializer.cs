...
namespace fastpix.io.Utils
{
    ...
    {
        public static FastPixHttpClient Apply(FastPixHttpClient client, Func<object> securitySource)
        {
            ...
            client = new FastPixHttpClient(client);
            ...
            foreach (var prop in props)
            {
                ...
                var metadata = prop.GetCustomAttribute<FastPixMetadata>().GetSecurityMetadata();
        ...
        private static void ApplyOption(ref FastPixHttpClient client, object option)
        {
        ...
        private static void ApplyBasicAuthScheme(ref FastPixHttpClient client, object scheme)
        {
            var props = scheme.GetType().GetProperties();
