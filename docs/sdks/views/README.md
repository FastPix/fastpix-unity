...
<!-- UsageSnippet language="unity" operationID="list_video_views" method="get" path="/data/viewlist" -->
```csharp
using fastpix.io;
...
<!-- UsageSnippet language="unity" operationID="get_video_view_details" method="get" path="/data/viewlist/{viewId}" -->
```csharp
using fastpix.io;
using fastpix.io.Models.Components;
using fastpix.io.Models.Requests;
...
<!-- UsageSnippet language="unity" operationID="list_by_top_content" method="get" path="/data/viewlist/top-content" -->
```csharp
using fastpix.io;
using fastpix.io.Models.Components;
using fastpix.io.Models.Requests;
...
<!-- UsageSnippet language="unity" operationID="get_/data/viewlist/current-views/getTimeseriesViews" method="get" path="/data/viewlist/current-views/getTimeseriesViews" -->
```csharp
using fastpix.io;
using fastpix.io.Models.Components;
...
<!-- UsageSnippet language="unity" operationID="get_/data/viewlist/current-views/filter" method="get" path="/data/viewlist/current-views/filter" -->
```csharp
using fastpix.io;
using fastpix.io.Models.Components;
using fastpix.io.Models.Requests;
